%% FIGURE 6: % Interaction effect - behaviour (BIS) X anxiety and resting state functional connectivity
% -------------------------------------------------------------------------
% This script reproduces Figure 6B/Figure 6D/Figure 6F from the manuscript and completes:
...
%   - Data file: 'Figure6$.mat' in present working directory 
%   - dependencies: error_ellipse.m in present working directory 
%
%
% OUTPUT:
%   - Figure replicating Figure 6B, 6D, 6F
%   - Statistical results 
%
...
behaviour = round(mean_bis_nuT, 3);
...
annotation('textbox', [0.75, 0.84, 0.1, 0.1], 'String', text1, 'Color',edgeColor_lowAnx, 'FontSize', 14, 'FontWeight', 'normal', 'EdgeColor', 'none');
annotation('textbox', [0.75,0.79, 0.1, 0.1], 'String', text2, 'Color',edgeColor_highAnx, 'FontSize', 14, 'FontWeight', 'normal', 'EdgeColor', 'none');
...
output_name = 'Figure6B'; %for Figure6D/6F: change it to Figure6D/6F
