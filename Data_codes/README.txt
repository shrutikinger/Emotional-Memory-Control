...
2.  Navigate to the specific figure subfolder inside code_files using
...
***Add the function error_ellipse to the path for generation of confidence ellipses for Figure 4,5,6,7
