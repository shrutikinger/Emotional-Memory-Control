%% FIGURE 4B: % Interaction effect - behaviour (BIS) X anxiety and resting state functional connectivity
% -------------------------------------------------------------------------
% This script reproduces Figure 4B from the manuscript and completes:
...
%   - Data file: 'Figure4B.mat' in present working directory 
%   - dependencies: error_ellipse.m in present working directory 
%
%
% OUTPUT:
%   - Figure replicating Figure 4B
%   - Statistical results 
%
...
behaviour = round(mean_bis_posNT, 3);
