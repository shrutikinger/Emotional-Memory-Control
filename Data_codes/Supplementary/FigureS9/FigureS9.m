%% FIGURE S9: Correlation between Working memory capacity & Reaction Time
% -------------------------------------------------------------------------
% This script reproduces Figure S9 from the manuscript and completes:
...
%   - Data file: 'FigureS9.mat' in present working directory 
%
%
% OUTPUT:
%   - Figure replicating Figure S9
%   - Statistical results 
%
...
[b_posT,stats_posT] = robustfit( k_posT',zscore(POS_Thk_CORRECT_RT'));
[b_posNT,stats_posNT] = robustfit( k_posNT',zscore(POS_NT_CORRECT_RT'));

[b_nuT,stats_nuT] =robustfit( k_nuT',zscore(NU_Thk_correct_RT'));
[b_nuNT,stats_nuNT] = robustfit( k_nuNT',zscore(NU_NT_correct_RT'));

[b_negT,stats_negT] = robustfit( k_negT',zscore(NEG_Thk_correct_RT'));
[b_negNT,stats_negNT] = robustfit( k_negNT',zscore(NEG_NT_correct_RT'));
