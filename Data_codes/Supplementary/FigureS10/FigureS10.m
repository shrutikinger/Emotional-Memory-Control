%% FIGURE S10: % Interaction effect - behaviour (BIS) X anxiety and resting state functional connectivity
% -------------------------------------------------------------------------
% This script reproduces Figure S10 from the manuscript and completes:
...
%   - Data file: 'FigureS10.mat' in present working directory 
%   - dependencies: error_ellipse.m in present working directory 
%
%
% OUTPUT:
%   - Figure replicating Figure S10
%   - Statistical results 
%
...
output_name = 'FigureS10'; %for Figure5D: change it to Figure5D
